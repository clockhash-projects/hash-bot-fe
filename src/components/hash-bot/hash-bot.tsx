                    ...
                    {this.isChatOpen && (
                        ...
                        >
                            <div class="chat-header">
                                ...
                                <span class="chat-status">{this.socket?.readyState === WebSocket.OPEN ? '(Online)' : '(Offline)'}</span>
                                <button class="close-button" onClick={() => this.toggleChat()}>✖</button>
                            </div>
                            ...
                            <div class="input-container">
                                ...
                                />
                                <button class="send-button" onClick={() => this.handleSendMessage()}>Send</button>
                            </div>
                        </div>
                    )}
                </div>
